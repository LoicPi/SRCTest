...
public interface ComptabiliteDao {
    ...
    /**
     * Renvoie la liste des Sequences d'Ecritures Comptables
     */
	...
	/**
     * Supprime la séquence d'écriture comptable de code journal {@code pJournalCode}.
     *
     * @param pJournalCode le code journal du journal lié à la séquence d'écriture comptable
     */
